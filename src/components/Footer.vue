	...
	<footer class="footer">
				...
				<div class="footer__body">
					<div class="footer__menu">
						<div class="footer__menu-block">
							<p class="footer__menu-title">Features</p>
							<ul class="footer__menu-list">
								<li class="footer__menu-item">
									<a href="#" class="footer__menu-link">Link Shortening</a>
								</li>
								<li class="footer__menu-item">
									<a href="#" class="footer__menu-link">Branded Links</a>
								</li>
								<li class="footer__menu-item">
									<a href="#" class="footer__menu-link">Analytics</a>
								</li>
							</ul>
						</div>
						<div class="footer__menu-block">
							...
							<ul class="footer__menu-list">
								...
								<li class="footer__menu-item">
									<a href="#" class="footer__menu-link">Developers</a>
								</li>
								<li class="footer__menu-item">
						...
						<div class="footer__menu-block">
							...
							<ul class="footer__menu-list">
								...
								<li class="footer__menu-item">
									<a href="#" class="footer__menu-link">Our Team</a>
								</li>
								<li class="footer__menu-item">
		...
		<div class="attribution">
			...
			<a href="https://www.frontendmentor.io?ref=challenge" target="_blank"
				>Frontend Mentor</a
			>. Coded by <a href="https://github.com/EvgiSs">EvgiSs</a>.
		</div>
	</footer>
</template>
